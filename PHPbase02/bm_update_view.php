   ...
   <form action="bm_update.php" method="post">
     <div class="jumbatron">
       <fieldset>
         ...
         <label>Bookmark：<input type="text" name="bmname" value="<?=$row["bmname"]?>" required></input></label><br>
         <label>URL：<input type="url" name="url" value="<?=$row["url"]?>" required></input></label><br>
